...
TODO croquis temporel avec SYN et ACK.
...
TODO Insérer la photo de la courbe
...
- *Même expérience avec un buffer...*
  - *... de 3000 octets*
  - De la même manière que précédemment on trouve un débit applicatif de : **3000 / 0,0188 * 8 = 1 276 595 bits/s = 1 276,595 kbits/s**
  - *... de 10 000 octets*
  - De la même manière que précédemment on trouve un débit applicatif de : **10 000 / 0.0224696 * 8 = 3 560 366 bits/s = 3 560,366 kbits/s**
