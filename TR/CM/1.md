...
- **Numéro d'acquittement.** Contient le numéro de séquence du prochain octet attendu (par l'émetteut de ce message) et acquitte tous les précédents octets.
...
![Chronogramme fin de connexion](img/2_fin.jpg)

#### Transfert de données

![Chronogramme transfert de données](img/3_transfert.jpg)
