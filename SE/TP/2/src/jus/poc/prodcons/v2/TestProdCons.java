...
public class TestProdCons {
	...
	public static void main(String[] args) throws IOException {
		...
		if (Options.ECHO_ALL_CONS_INTERRUPTED) {
			System.out.println("Le programme principal est fini.");
			System.out.println("Temps d'exécution : " + timeElapsed + "ms");
			System.out.println("Ratio : " + ((float) totMsgGoal/timeElapsed) + " messages par ms");
		}
