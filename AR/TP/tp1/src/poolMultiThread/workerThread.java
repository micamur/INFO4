...
public class workerThread extends Thread {
	...
	Socket client;
	String dir;
	ArrayBlockingQueue<Socket> arraySocketClient;

	public workerThread(String dir, ArrayBlockingQueue<Socket> arraySocketClient) {
		this.dir = dir;
		this.arraySocketClient = arraySocketClient;
		start();
	}
	...
	public void run() {
		try {
			...
			// get the client socket in the buffer
			client = arraySocketClient.take();
